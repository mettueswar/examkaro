...
const ADMIN_NAV = [
  ...
  { label: "AI Plans", href: "/admin/subscription-plans", icon: Brain },
    ...
    <div className="flex min-h-screen bg-surface-50">
      ...
      <aside className="w-56 bg-surface-900 text-surface-300 flex flex-col shrink-0 hidden lg:flex">
        <div className="px-4 py-4 border-b border-surface-700">
          <Link
            href="/"
            className="flex items-center gap-2 text-white font-display font-bold"
          >
        ...
        <div className="px-4 py-3 border-t border-surface-700 text-xs text-surface-500">
          Logged as{" "}
          <span className="text-surface-300 font-medium capitalize">
            {auth.role}
          </span>
        </div>
      </aside>
