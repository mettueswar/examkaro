...
interface Quiz {
  ...
  difficulty: string;
  // FIX: DB column is "attempts" (not "attempt_count"), camelCase stays "attempts"
  attempts: number;
  createdAt: string;
}
      ...
      return (
        <div className="max-w-lg mx-auto py-8 text-center">
          ...
          >
            <Trophy
              size={36}
              className={score >= 60 ? "text-green-600" : "text-red-500"}
            />
          </div>
    ...
    return (
      <div className="max-w-2xl mx-auto">
        ...
        <div className="card p-5 mb-4">
          <p className="text-surface-800 font-medium text-base leading-relaxed mb-5">
            {currentQ.question}
          </p>
              ...
              return (
                <button
                  ...
                  onClick={() =>
                    ...
                    setQuizState((s) => ({
                      ...s,
                      answers: { ...s.answers, [currentQ.id]: opt.id },
    ...
    <div>
      ...
      {showForm && (
        <div className="card p-5 mb-5 border-2 border-brand-200 bg-brand-50/20">
          ...
          <div className="grid sm:grid-cols-2 gap-4 mb-4">
            <div className="sm:col-span-2">
              ...
              <input
                ...
                placeholder="e.g. Indian Geography Quiz"
              />
            </div>
            <div>
              <label className="block text-xs font-semibold text-surface-700 mb-1">
            ...
            {!form.materialId && (
              <div className="sm:col-span-2">
                ...
                <textarea
                  ...
                  placeholder="Paste study content... (min 100 chars)"
                />
              </div>
            )}
          </div>
          <div className="flex gap-3">
            ...
            >
              {generating ? (
                ...
                <>
                  <Sparkles size={14} /> Generate {form.count} Questions
                </>
              )}
            </button>
            <button
          ...
          {generating && (
            <p className="text-xs text-brand-500 mt-3 animate-pulse">
              ✨ Gemini AI is creating your quiz... 15–30 seconds.
            </p>
          )}
        </div>
      )}
      ...
      {loading ? (
        ...
        <div className="card p-12 text-center text-surface-400">
          ...
          <p className="text-sm mt-1">
            Generate an AI quiz from any study material
          </p>
        </div>
      ) : (
        <div className="grid sm:grid-cols-2 gap-4">
          {quizzes.map((quiz) => (
            ...
            >
              ...
              {/* FIX: was quiz.attemptCount — DB column is "attempts" (not "attempt_count") → stays as "attempts" */}
